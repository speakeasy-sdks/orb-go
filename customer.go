...
func (s *customer) Get(ctx context.Context, request operations.GetExternalCustomerCostsRequest) (*operations.GetExternalCustomerCostsResponse, error) {
	baseURL := s.serverURL
	...
	res := &operations.GetExternalCustomerCostsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *operations.GetExternalCustomerCosts200ApplicationJSON
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
