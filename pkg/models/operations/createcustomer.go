...
type CreateCustomerRequestBodyPaymentProvider string

const (
	CreateCustomerRequestBodyPaymentProviderQuickbooks    CreateCustomerRequestBodyPaymentProvider = "quickbooks"
	CreateCustomerRequestBodyPaymentProviderBillCom       CreateCustomerRequestBodyPaymentProvider = "bill.com"
	CreateCustomerRequestBodyPaymentProviderStripeCharge  CreateCustomerRequestBodyPaymentProvider = "stripe_charge"
	CreateCustomerRequestBodyPaymentProviderStripeInvoice CreateCustomerRequestBodyPaymentProvider = "stripe_invoice"
	CreateCustomerRequestBodyPaymentProviderNull          CreateCustomerRequestBodyPaymentProvider = "null"
)

func (e CreateCustomerRequestBodyPaymentProvider) ToPointer() *CreateCustomerRequestBodyPaymentProvider {
	return &e
}

func (e *CreateCustomerRequestBodyPaymentProvider) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "stripe_invoice":
		fallthrough
	case "null":
		*e = CreateCustomerRequestBodyPaymentProvider(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateCustomerRequestBodyPaymentProvider: %v", v)
	}
}
...
type CreateCustomerRequestBody struct {
	...
	// - the connection must first be configured in the Orb webapp.
	// - if the provider is an invoicing provider (`stripe_invoice`, `quickbooks`, `bill.com`), any product mappings must first be configured with the Orb team.
	PaymentProvider *CreateCustomerRequestBodyPaymentProvider `json:"payment_provider,omitempty"`
