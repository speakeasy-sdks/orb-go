...
type GetSubscriptionsSubscriptionIDCostRequest struct {
...
type GetSubscriptionsSubscriptionIDCost200ApplicationJSONDataPerPriceCostsPriceGroups struct {
...
type GetSubscriptionsSubscriptionIDCost200ApplicationJSONDataPerPriceCosts struct {
	...
	PriceGroups []GetSubscriptionsSubscriptionIDCost200ApplicationJSONDataPerPriceCostsPriceGroups `json:"price_groups"`
...
type GetSubscriptionsSubscriptionIDCost200ApplicationJSONData struct {
	PerPriceCosts []GetSubscriptionsSubscriptionIDCost200ApplicationJSONDataPerPriceCosts `json:"per_price_costs"`
...
type GetSubscriptionsSubscriptionIDCost200ApplicationJSON struct {
	Data               []GetSubscriptionsSubscriptionIDCost200ApplicationJSONData `json:"data"`
	PaginationMetadata map[string]interface{}                                     `json:"pagination_metadata"`
}

type GetSubscriptionsSubscriptionIDCostResponse struct {
	ContentType string
	StatusCode  int
	RawResponse *http.Response
	// OK
	GetSubscriptionsSubscriptionIDCost200ApplicationJSONObject *GetSubscriptionsSubscriptionIDCost200ApplicationJSON
}
