...
type FetchCustomerCostsExternalIDViewMode string

const (
	FetchCustomerCostsExternalIDViewModePeriodic   FetchCustomerCostsExternalIDViewMode = "periodic"
	FetchCustomerCostsExternalIDViewModeCumulative FetchCustomerCostsExternalIDViewMode = "cumulative"
)

func (e FetchCustomerCostsExternalIDViewMode) ToPointer() *FetchCustomerCostsExternalIDViewMode {
	return &e
}

func (e *FetchCustomerCostsExternalIDViewMode) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "periodic":
		fallthrough
	case "cumulative":
		*e = FetchCustomerCostsExternalIDViewMode(v)
		return nil
	default:
		return fmt.Errorf("invalid value for FetchCustomerCostsExternalIDViewMode: %v", v)
	}
}

type FetchCustomerCostsExternalIDRequest struct {
	...
	ViewMode *FetchCustomerCostsExternalIDViewMode `queryParam:"style=form,explode=true,name=view_mode"`
}

type FetchCustomerCostsExternalID200ApplicationJSONDataPerPriceCostsPriceGroups struct {
...
type FetchCustomerCostsExternalID200ApplicationJSONDataPerPriceCosts struct {
	...
	PriceGroups []FetchCustomerCostsExternalID200ApplicationJSONDataPerPriceCostsPriceGroups `json:"price_groups"`
...
type FetchCustomerCostsExternalID200ApplicationJSONData struct {
	PerPriceCosts []FetchCustomerCostsExternalID200ApplicationJSONDataPerPriceCosts `json:"per_price_costs"`
...
type FetchCustomerCostsExternalID200ApplicationJSON struct {
	Data               []FetchCustomerCostsExternalID200ApplicationJSONData `json:"data"`
	PaginationMetadata shared.PaginationMetadata                            `json:"pagination_metadata"`
}

type FetchCustomerCostsExternalIDResponse struct {
	ContentType string
	StatusCode  int
	RawResponse *http.Response
	// OK
	FetchCustomerCostsExternalID200ApplicationJSONObject *FetchCustomerCostsExternalID200ApplicationJSON
}
