...
type FetchSubscriptionCostsRequest struct {
...
type FetchSubscriptionCosts200ApplicationJSONDataPerPriceCostsPriceGroups struct {
...
type FetchSubscriptionCosts200ApplicationJSONDataPerPriceCosts struct {
	...
	PriceGroups []FetchSubscriptionCosts200ApplicationJSONDataPerPriceCostsPriceGroups `json:"price_groups"`
...
type FetchSubscriptionCosts200ApplicationJSONData struct {
	PerPriceCosts []FetchSubscriptionCosts200ApplicationJSONDataPerPriceCosts `json:"per_price_costs"`
...
type FetchSubscriptionCosts200ApplicationJSON struct {
	Data               []FetchSubscriptionCosts200ApplicationJSONData `json:"data"`
	PaginationMetadata shared.PaginationMetadata                      `json:"pagination_metadata"`
}

type FetchSubscriptionCostsResponse struct {
	ContentType string
	StatusCode  int
	RawResponse *http.Response
	// OK
	FetchSubscriptionCosts200ApplicationJSONObject *FetchSubscriptionCosts200ApplicationJSON
}
