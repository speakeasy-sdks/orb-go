...
func (e *GetExternalCustomerCostsViewModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "periodic":
		fallthrough
	case "cumulative":
		*e = GetExternalCustomerCostsViewModeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetExternalCustomerCostsViewModeEnum: %s", s)
	}
}

type GetExternalCustomerCostsRequest struct {
...
type GetExternalCustomerCosts200ApplicationJSONDataPerPriceCosts struct {
	...
	PriceGroups []GetExternalCustomerCosts200ApplicationJSONDataPerPriceCostsPriceGroups `json:"price_groups"`
...
type GetExternalCustomerCosts200ApplicationJSONData struct {
	PerPriceCosts []GetExternalCustomerCosts200ApplicationJSONDataPerPriceCosts `json:"per_price_costs"`
...
type GetExternalCustomerCosts200ApplicationJSON struct {
	Data               []GetExternalCustomerCosts200ApplicationJSONData `json:"data"`
	PaginationMetadata map[string]interface{}                           `json:"pagination_metadata"`
}

type GetExternalCustomerCostsResponse struct {
	ContentType string
	StatusCode  int
	RawResponse *http.Response
	// OK
	GetExternalCustomerCosts200ApplicationJSONObject *GetExternalCustomerCosts200ApplicationJSON
}
