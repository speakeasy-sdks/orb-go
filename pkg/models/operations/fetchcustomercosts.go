...
type FetchCustomerCostsViewMode string

const (
	FetchCustomerCostsViewModePeriodic   FetchCustomerCostsViewMode = "periodic"
	FetchCustomerCostsViewModeCumulative FetchCustomerCostsViewMode = "cumulative"
)

func (e FetchCustomerCostsViewMode) ToPointer() *FetchCustomerCostsViewMode {
	return &e
}

func (e *FetchCustomerCostsViewMode) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "periodic":
		fallthrough
	case "cumulative":
		*e = FetchCustomerCostsViewMode(v)
		return nil
	default:
		return fmt.Errorf("invalid value for FetchCustomerCostsViewMode: %v", v)
	}
}

type FetchCustomerCostsRequest struct {
	// The Orb Customer ID
	...
	ViewMode *FetchCustomerCostsViewMode `queryParam:"style=form,explode=true,name=view_mode"`
}

type FetchCustomerCosts200ApplicationJSONDataPerPriceCostsPriceGroups struct {
...
type FetchCustomerCosts200ApplicationJSONDataPerPriceCosts struct {
	...
	PriceGroups []FetchCustomerCosts200ApplicationJSONDataPerPriceCostsPriceGroups `json:"price_groups"`
...
type FetchCustomerCosts200ApplicationJSONData struct {
	PerPriceCosts []FetchCustomerCosts200ApplicationJSONDataPerPriceCosts `json:"per_price_costs"`
...
type FetchCustomerCosts200ApplicationJSON struct {
	Data               []FetchCustomerCosts200ApplicationJSONData `json:"data"`
	PaginationMetadata shared.PaginationMetadata                  `json:"pagination_metadata"`
}

type FetchCustomerCostsResponse struct {
	ContentType string
	StatusCode  int
	RawResponse *http.Response
	// OK
	FetchCustomerCosts200ApplicationJSONObject *FetchCustomerCosts200ApplicationJSON
}
