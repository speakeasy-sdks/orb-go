...
func main() {
    ...
    res, err := s.Subscription.Cancel(ctx, operations.CancelSubscriptionRequest{
        RequestBody: &operations.CancelSubscriptionRequestBody{
            CancelOption: operations.CancelSubscriptionRequestBodyCancelOptionImmediate,
            CancellationDate: types.MustTimeFromString("2017-07-21T17:32:28Z"),
        },
        SubscriptionID: "cum",
    })
    if err != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Subscription.Create(ctx, []byte("commodi"))
    if err != nil {
        log.Fatal(err)
    }
...
**[*operations.CreateSubscriptionRawResponse](../../models/operations/createsubscriptionrawresponse.md), error**
...
func main() {
    ...
    res, err := s.Subscription.Create(ctx, operations.CreateSubscriptionApplicationJSON{
        ...
        CouponRedemptionCode: sdk.String("in"),
        CustomerID: sdk.String("97DPcZE9hxsbb9Y9"),
        DefaultInvoiceMemo: sdk.String("corporis"),
        ...
        ExternalPlanID: sdk.String("assumenda"),
        Metadata: &operations.CreateSubscriptionApplicationJSONMetadata{},
        ...
        PhaseOverrides: []CreateSubscriptionApplicationJSONPhaseOverrides{
            operations.CreateSubscriptionApplicationJSONPhaseOverrides{
                Discount: &shared.Discount{
                    AmountDiscount: sdk.String("recusandae"),
                    ...
                    TrialAmountDiscount: sdk.String("consectetur"),
                    UsageDiscount: sdk.Float64(4490.83),
                },
                MinimumAmount: sdk.String("exercitationem"),
                Order: sdk.Float64(9372.85),
            },
            operations.CreateSubscriptionApplicationJSONPhaseOverrides{
                Discount: &shared.Discount{
                    AmountDiscount: sdk.String("facere"),
                    AppliesToPriceIds: []string{
                        "doloribus",
                        "suscipit",
                    },
                    ...
                    UsageDiscount: sdk.Float64(6971.42),
                },
                MinimumAmount: sdk.String("saepe"),
                Order: sdk.Float64(8970.71),
            },
        },
...
| ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------ |
| `ctx`                                                                                                        | [context.Context](https://pkg.go.dev/context#Context)                                                        | :heavy_check_mark:                                                                                           | The context to use for the request.                                                                          |
| `request`                                                                                                    | [operations.CreateSubscriptionApplicationJSON](../../models/operations/createsubscriptionapplicationjson.md) | :heavy_check_mark:                                                                                           | The request object to use for the request.                                                                   |


### Response

**[*operations.CreateSubscriptionJSONResponse](../../models/operations/createsubscriptionjsonresponse.md), error**
...
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ |
| `ctx`                                                                                      | [context.Context](https://pkg.go.dev/context#Context)                                      | :heavy_check_mark:                                                                         | The context to use for the request.                                                        |
| `request`                                                                                  | [operations.FetchSubscriptionRequest](../../models/operations/fetchsubscriptionrequest.md) | :heavy_check_mark:                                                                         | The request object to use for the request.                                                 |


### Response

**[*operations.FetchSubscriptionResponse](../../models/operations/fetchsubscriptionresponse.md), error**
...
func main() {
    ...
    res, err := s.Subscription.FetchCosts(ctx, operations.FetchSubscriptionCostsRequest{
        GroupBy: sdk.String("asperiores"),
        SubscriptionID: "adipisci",
        TimeframeEnd: types.MustTimeFromString("2022-02-02T05:00:00Z"),
        TimeframeStart: types.MustTimeFromString("2022-02-02T05:00:00Z"),
        ViewMode: sdk.String("non"),
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.FetchSubscriptionCosts200ApplicationJSONObject != nil {
        // handle response
    }
}
```
...
**[*operations.FetchSubscriptionCostsResponse](../../models/operations/fetchsubscriptioncostsresponse.md), error**
...
func main() {
    ...
    if res.FetchSubscriptionSchedule200ApplicationJSONObject != nil {
        // handle response
    }
}
```
...
| ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| `ctx`                                                                                                      | [context.Context](https://pkg.go.dev/context#Context)                                                      | :heavy_check_mark:                                                                                         | The context to use for the request.                                                                        |
| `request`                                                                                                  | [operations.FetchSubscriptionScheduleRequest](../../models/operations/fetchsubscriptionschedulerequest.md) | :heavy_check_mark:                                                                                         | The request object to use for the request.                                                                 |


### Response

**[*operations.FetchSubscriptionScheduleResponse](../../models/operations/fetchsubscriptionscheduleresponse.md), error**
...
func main() {
    ...
    if res.FetchSubscriptionUsage200ApplicationJSONObject != nil {
        // handle response
    }
}
```
...
**[*operations.FetchSubscriptionUsageResponse](../../models/operations/fetchsubscriptionusageresponse.md), error**
...
func main() {
    ...
    res, err := s.Subscription.List(ctx, operations.ListSubscriptionsRequest{
        CustomerID: sdk.String("consectetur"),
        ExternalCustomerID: sdk.String("corporis"),
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.ListSubscriptions200ApplicationJSONObject != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Subscription.SchedulePlanChange(ctx, operations.SchedulePlanChangeRequest{
        RequestBody: &operations.SchedulePlanChangeRequestBody{
            ...
            CouponRedemptionCode: sdk.String("laboriosam"),
...
| -------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| `ctx`                                                                                        | [context.Context](https://pkg.go.dev/context#Context)                                        | :heavy_check_mark:                                                                           | The context to use for the request.                                                          |
| `request`                                                                                    | [operations.SchedulePlanChangeRequest](../../models/operations/scheduleplanchangerequest.md) | :heavy_check_mark:                                                                           | The request object to use for the request.                                                   |


### Response

**[*operations.SchedulePlanChangeResponse](../../models/operations/scheduleplanchangeresponse.md), error**
...
| ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| `ctx`                                                                                                | [context.Context](https://pkg.go.dev/context#Context)                                                | :heavy_check_mark:                                                                                   | The context to use for the request.                                                                  |
| `request`                                                                                            | [operations.UnscheduleCancellationRequest](../../models/operations/unschedulecancellationrequest.md) | :heavy_check_mark:                                                                                   | The request object to use for the request.                                                           |


### Response

**[*operations.UnscheduleCancellationResponse](../../models/operations/unschedulecancellationresponse.md), error**
...
| ------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------ |
| `ctx`                                                                                            | [context.Context](https://pkg.go.dev/context#Context)                                            | :heavy_check_mark:                                                                               | The context to use for the request.                                                              |
| `request`                                                                                        | [operations.UnschedulePlanChangeRequest](../../models/operations/unscheduleplanchangerequest.md) | :heavy_check_mark:                                                                               | The request object to use for the request.                                                       |


### Response

**[*operations.UnschedulePlanChangeResponse](../../models/operations/unscheduleplanchangeresponse.md), error**
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Subscription.UpdateFixedFeeQuantity(ctx, operations.UpdateFixedFeeQuantityRequest{
...
| ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| `ctx`                                                                                                | [context.Context](https://pkg.go.dev/context#Context)                                                | :heavy_check_mark:                                                                                   | The context to use for the request.                                                                  |
| `request`                                                                                            | [operations.UpdateFixedFeeQuantityRequest](../../models/operations/updatefixedfeequantityrequest.md) | :heavy_check_mark:                                                                                   | The request object to use for the request.                                                           |


### Response

**[*operations.UpdateFixedFeeQuantityResponse](../../models/operations/updatefixedfeequantityresponse.md), error**
